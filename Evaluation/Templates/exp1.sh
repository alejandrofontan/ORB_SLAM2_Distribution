...
exp="robustOutlierRejection_orb_test3"
numRuns=1
...
#./run_SLAM.sh orbslam2 mono test1 2023_06_23 y 1 ${numRuns} rgbdtum rgbd_dataset_freiburg3_long_office_household 0 /home/alex vocabulary ORB_SLAM2_Distribution ${exp}
...
#./run_SLAM.sh orbslam2 mono test1 2023_06_23 y 1 ${numRuns} rgbdtum rgbd_dataset_freiburg2_xyz 0 /home/alex vocabulary ORB_SLAM2_Distribution ${exp}
